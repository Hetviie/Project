...
///////////////////// VARIABLES ////////////////////
lv_anim_t * welcom_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * settingPnl_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * settingClosePnl_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * stettingPnlStngClsBtn_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * settingClsOrgn_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * settingPnl_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_0, 50, 200);
    ...
    lv_anim_set_values(&PropertyAnimation_1, 50, 300);
...
lv_anim_t * settingClosePnl_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_0, 431, 50);
    lv_anim_set_path_cb(&PropertyAnimation_0, lv_anim_path_ease_out);
    ...
    lv_anim_set_values(&PropertyAnimation_1, 147, 50);
    lv_anim_set_path_cb(&PropertyAnimation_1, lv_anim_path_ease_out);
...
lv_anim_t * stettingPnlStngClsBtn_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_0, -50, -120);
    lv_anim_set_path_cb(&PropertyAnimation_0, lv_anim_path_ease_out);
    lv_anim_set_delay(&PropertyAnimation_0, delay + 0);
    lv_anim_set_deleted_cb(&PropertyAnimation_0, _ui_anim_callback_free_user_data);
    lv_anim_set_playback_time(&PropertyAnimation_0, 0);
...
lv_anim_t * settingClsOrgn_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_user_data(&PropertyAnimation_0, PropertyAnimation_0_user_data);
    lv_anim_set_custom_exec_cb(&PropertyAnimation_0, _ui_anim_callback_set_x);
    lv_anim_set_values(&PropertyAnimation_0, -120, -50);
    lv_anim_set_path_cb(&PropertyAnimation_0, lv_anim_path_ease_out);
    lv_anim_set_delay(&PropertyAnimation_0, delay + 0);
    lv_anim_set_deleted_cb(&PropertyAnimation_0, _ui_anim_callback_free_user_data);
    lv_anim_set_playback_time(&PropertyAnimation_0, 0);
